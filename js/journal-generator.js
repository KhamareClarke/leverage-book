...
function generateChapter1VisionComplete(startPageNumber = 10) {
    ...
    <div class="page">
        ...
        <!-- Strategic Influence Network Section -->
        <div style="background: var(--black-card); padding: 1.5rem; border-radius: 12px; border: 2px solid var(--gold);">
            <h3 style="color: var(--gold); font-size: 1.2rem; margin-bottom: 0.8rem;">👥 MENTORS & POWER ALLIES</h3>
            <p style="color: var(--gray-light); font-size: 0.85rem; margin-bottom: 0.6rem;">Who do you study and strategically align with? Identify those whose influence you can leverage.</p>
            <div style="display: flex; margin-bottom: 0.8rem;">
                <div style="width: 30%; color: var(--gold-light); font-size: 0.75rem; padding-right: 0.5rem;">Name/Position:</div>
                <div style="width: 70%; border-bottom: 1px solid var(--gray-dark); height: 1.8rem;"></div>
            </div>
            <div style="display: flex; margin-bottom: 0.8rem;">
                <div style="width: 30%; color: var(--gold-light); font-size: 0.75rem; padding-right: 0.5rem;">Strategic Value:</div>
                <div style="width: 70%; border-bottom: 1px solid var(--gray-dark); height: 1.8rem;"></div>
            </div>
            <div style="display: flex;">
                <div style="width: 30%; color: var(--gold-light); font-size: 0.75rem; padding-right: 0.5rem;">Access Method:</div>
                <div style="width: 70%; border-bottom: 1px solid var(--gray-dark); height: 1.8rem;"></div>
            </div>
        </div>
    ...
    <div class="page" style="padding-top: 0; margin-top: -0.5rem;">
        ...
        <!-- Execution Framework -->
        <div style="background: rgba(212, 175, 55, 0.05); padding: 0.2rem; border-radius: 6px; margin-bottom: 0.2rem; border: 1px solid rgba(212, 175, 55, 0.2);">
            <p style="color: var(--gold); font-size: 0.8rem; margin: 0 0 0.05rem 0; font-weight: 600; text-align: center;">
                "EXECUTION EATS STRATEGY FOR BREAKFAST" - PETER DRUCKER
            </p>
            <p style="color: var(--gray-light); font-size: 0.7rem; margin: 0; line-height: 1.1; text-align: center;">
                Specific, measurable actions with deadlines create unstoppable momentum.
            </p>
        </div>
        
        <div class="tactical-goals" style="display: grid; gap: 0.2rem;">
            <!-- 3-6 Month Tactical Goals with Specific Prompts -->
            <div class="timeline-section" style="background: var(--black-card); padding: 0.3rem; border-radius: 6px; border-left: 3px solid #FFA500;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.2rem;">
                    <h3 style="color: #FFA500; margin: 0; font-size: 0.8rem; display: flex; align-items: center;">
                        <span style="font-size: 0.9rem; margin-right: 0.2rem;">⚡</span>
                        TACTICAL MILESTONES (3-6 Months)
                    </h3>
                    <span style="color: var(--gold-light); font-size: 0.65rem;">Format: [Result] by [Date]</span>
                </div>
                
                <div class="goal-lines">
                    <div style="display: flex; margin: 0.2rem 0;">
                        <div style="width: 15%; color: var(--gold-light); font-size: 0.7rem; padding-right: 0.2rem;">Milestone 1:</div>
                        <div style="width: 85%; border-bottom: 1px solid var(--gray-dark); height: 1.7rem;"></div>
                    </div>
                    <div style="display: flex; margin: 0.2rem 0;">
                        <div style="width: 15%; color: var(--gold-light); font-size: 0.7rem; padding-right: 0.2rem;">Milestone 2:</div>
                        <div style="width: 85%; border-bottom: 1px solid var(--gray-dark); height: 1.7rem;"></div>
                    </div>
                    <div style="display: flex; margin: 0.2rem 0;">
                        <div style="width: 15%; color: var(--gold-light); font-size: 0.7rem; padding-right: 0.2rem;">Milestone 3:</div>
                        <div style="width: 85%; border-bottom: 1px solid var(--gray-dark); height: 1.7rem;"></div>
                    </div>
                </div>
                
                <!-- Added content about bridge goals with writing lines -->
                <div style="margin-top: 0.3rem; padding: 0.2rem; border-top: 1px dashed var(--gray-dark);">
                    <p style="color: var(--gold-light); font-size: 0.7rem; margin: 0; display: flex; align-items: center;">
                        <span style="font-size: 0.8rem; margin-right: 0.2rem;">⚡</span>
                        TACTICAL (3-6 Months)
                    </p>
                    <p style="color: var(--gray-light); font-size: 0.65rem; margin: 0.05rem 0 0.15rem 0;">
                        Bridge goals for strategic objectives.
                    </p>
                    <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.15rem 0; height: 1.5rem;"></div>
                    <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.15rem 0; height: 1.5rem;"></div>
                    <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.15rem 0; height: 1.5rem;"></div>
                </div>
            </div>
            
            <!-- Current Quarter Focus with Action Specificity -->
            <div class="timeline-section" style="background: var(--black-card); padding: 0.3rem; border-radius: 6px; border-left: 3px solid #32CD32;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.2rem;">
                    <h3 style="color: #32CD32; margin: 0; font-size: 0.8rem; display: flex; align-items: center;">
                        <span style="font-size: 0.9rem; margin-right: 0.2rem;">🚀</span>
                        90-DAY ACTION PLAN
                    </h3>
                    <span style="color: var(--gold-light); font-size: 0.65rem;">Format: [Verb] + [Metric] + [Timeline]</span>
                </div>
                
                <div class="goal-categories" style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.2rem; margin-top: 0.15rem;">
                    <div>
                        <h4 style="color: var(--gold-light); font-size: 0.7rem; margin: 0 0 0.1rem 0;">💼 CAREER</h4>
                        <div style="font-size: 0.65rem; color: var(--gray-light); margin-bottom: 0.1rem;">Example: Complete certification by 2/15</div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                    </div>
                    <div>
                        <h4 style="color: var(--gold-light); font-size: 0.7rem; margin: 0 0 0.1rem 0;">💪 HEALTH</h4>
                        <div style="font-size: 0.65rem; color: var(--gray-light); margin-bottom: 0.1rem;">Example: Exercise 4x/week for 30 days</div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                    </div>
                    <div>
                        <h4 style="color: var(--gold-light); font-size: 0.7rem; margin: 0 0 0.1rem 0;">💰 FINANCIAL</h4>
                        <div style="font-size: 0.65rem; color: var(--gray-light); margin-bottom: 0.1rem;">Example: Save $3,000 by March 31</div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                    </div>
                    <div>
                        <h4 style="color: var(--gold-light); font-size: 0.7rem; margin: 0 0 0.1rem 0;">❤️ RELATIONSHIPS</h4>
                        <div style="font-size: 0.65rem; color: var(--gray-light); margin-bottom: 0.1rem;">Example: Weekly date nights for Q1</div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                    </div>
                    <div>
                        <h4 style="color: var(--gold-light); font-size: 0.7rem; margin: 0 0 0.1rem 0;">🎓 LEARNING</h4>
                        <div style="font-size: 0.65rem; color: var(--gray-light); margin-bottom: 0.1rem;">Example: Read 6 books by June 1</div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                    </div>
                    <div>
                        <h4 style="color: var(--gold-light); font-size: 0.7rem; margin: 0 0 0.1rem 0;">🌟 GROWTH</h4>
                        <div style="font-size: 0.65rem; color: var(--gray-light); margin-bottom: 0.1rem;">Example: Meditate 10 min daily for 30 days</div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                        <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.1rem 0; height: 1.6rem;"></div>
                    </div>
                </div>
    ...
    <div class="page" style="padding-top: 0.25rem;">
        ...
        <div class="story-section" style="background: rgba(212, 175, 55, 0.05); padding: 0.75rem; border-radius: 6px; border: 1px solid var(--gold); margin: 0.5rem 0;">
            <h3 style="color: var(--gold); margin: 0 0 0.3rem 0; font-size: 0.95rem;">📖 Your Story Begins Now</h3>
            <p style="color: var(--gray-light); font-size: 0.85rem; line-height: 1.3; margin: 0 0 0.4rem 0;">
                Every hero's journey begins with a call to adventure. Yours started the moment you opened this journal. Like Odysseus leaving Troy, like Colonel Sanders starting KFC at age 62, like every entrepreneur who ever bet on themselves-you've answered the call.
            </p>
            <p style="color: var(--gray-light); font-size: 0.85rem; line-height: 1.3; margin: 0;">
                But the journey ahead has dragons. The dragon of self-doubt whispers you're not good enough. The dragon of comfort tempts you to stay where you are. The dragon of fear shows you all the ways you could fail.
            </p>
        </div>
        
        <div class="story-prompt" style="margin-bottom: 1rem;">
            <h4 style="color: var(--gold); margin-bottom: 0.3rem; font-size: 0.95rem;">✍️ Write Your Origin Story</h4>
            <p style="color: var(--gray-light); font-size: 0.8rem; font-style: italic; margin-bottom: 0.3rem;">
                What moment in your life led you here? What was your "enough is enough" moment?
            </p>
            <div class="writing-lines">
                <div style="border-bottom: 1px solid var(--gray-dark); margin: 0.35rem 0; height: 22px;"></div>
        ...
        <div class="hero-archetypes" style="background: var(--black-card); padding: 0.8rem; border-radius: 8px;">
            <h4 style="color: var(--gold); margin-bottom: 0.5rem; font-size: 0.95rem;">🗡️ Which Hero Are You?</h4>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
                <div style="padding: 0.3rem; border: 1px solid var(--gold-dark); border-radius: 4px;">
                    <strong style="color: var(--gold-light); font-size: 0.85rem;">The Warrior</strong>
                    <p style="color: var(--gray); font-size: 0.75rem; margin: 0;">Fights through obstacles</p>
                </div>
                <div style="padding: 0.3rem; border: 1px solid var(--gold-dark); border-radius: 4px;">
                    <strong style="color: var(--gold-light); font-size: 0.85rem;">The Sage</strong>
                    <p style="color: var(--gray); font-size: 0.75rem; margin: 0;">Seeks wisdom & truth</p>
                </div>
                <div style="padding: 0.3rem; border: 1px solid var(--gold-dark); border-radius: 4px;">
                    <strong style="color: var(--gold-light); font-size: 0.85rem;">The Explorer</strong>
                    <p style="color: var(--gray); font-size: 0.75rem; margin: 0;">Discovers new paths</p>
                </div>
                <div style="padding: 0.3rem; border: 1px solid var(--gold-dark); border-radius: 4px;">
                    <strong style="color: var(--gold-light); font-size: 0.85rem;">The Creator</strong>
                    <p style="color: var(--gray); font-size: 0.75rem; margin: 0;">Builds new worlds</p>
                </div>
            </div>
        </div>
...
function generateChapter2Plan() {
    ...
    <div class="page" style="padding: 5mm;">
        ...
        <p style="font-size: 1.2rem; line-height: 1.2; margin: 0.3rem 0 0.5rem 0; text-align: center; color: var(--gold-light);">Master these laws to achieve maximum results with minimum effort.</p>
        ...
        <div class="laws-grid" style="display: grid; grid-template-columns: 1fr; gap: 0.3rem; margin: 0.5rem 0;">
            <div class="law-item" style="background: var(--black-card); padding: 0.4rem; border-radius: 3px; border-left: 2px solid var(--gold);">
                <h4 style="color: var(--gold); margin: 0 0 0.1rem 0; font-size: 1.2rem; font-weight: bold; line-height: 1.1;">1. Compound Focus</h4>
                <p style="color: var(--gray-light); font-size: 1.05rem; line-height: 1.1; margin: 0;">Small, consistent actions compound over time.</p>
            </div>
            
            <div class="law-item" style="background: var(--black-card); padding: 0.4rem; border-radius: 3px; border-left: 2px solid var(--gold);">
                <h4 style="color: var(--gold); margin: 0 0 0.1rem 0; font-size: 1.2rem; font-weight: bold; line-height: 1.1;">2. Strategic Constraint</h4>
                <p style="color: var(--gray-light); font-size: 1.05rem; line-height: 1.1; margin: 0;">Intelligent limits create infinite possibilities.</p>
            </div>
            
            <div class="law-item" style="background: var(--black-card); padding: 0.4rem; border-radius: 3px; border-left: 2px solid var(--gold);">
                <h4 style="color: var(--gold); margin: 0 0 0.1rem 0; font-size: 1.2rem; font-weight: bold; line-height: 1.1;">3. System Supremacy</h4>
                <p style="color: var(--gray-light); font-size: 1.05rem; line-height: 1.1; margin: 0;">Systems beat goals. Build systems that work without you.</p>
            </div>
            
            <div class="law-item" style="background: var(--black-card); padding: 0.4rem; border-radius: 3px; border-left: 2px solid var(--gold);">
                <h4 style="color: var(--gold); margin: 0 0 0.1rem 0; font-size: 1.2rem; font-weight: bold; line-height: 1.1;">4. Identity Transformation</h4>
                <p style="color: var(--gray-light); font-size: 1.05rem; line-height: 1.1; margin: 0;">Change your identity, change your reality.</p>
            </div>
            
            <div class="law-item" style="background: var(--black-card); padding: 0.4rem; border-radius: 3px; border-left: 2px solid var(--gold);">
                <h4 style="color: var(--gold); margin: 0 0 0.1rem 0; font-size: 1.2rem; font-weight: bold; line-height: 1.1;">5. Environmental Design</h4>
                <p style="color: var(--gray-light); font-size: 1.05rem; line-height: 1.1; margin: 0;">Shape your environment, shape your behavior.</p>
            </div>
            
            <div class="law-item" style="background: var(--black-card); padding: 0.4rem; border-radius: 3px; border-left: 2px solid var(--gold);">
                <h4 style="color: var(--gold); margin: 0 0 0.1rem 0; font-size: 1.2rem; font-weight: bold; line-height: 1.1;">6. Momentum Multiplication</h4>
                <p style="color: var(--gray-light); font-size: 1.05rem; line-height: 1.1; margin: 0;">Success accelerates through momentum.</p>
            </div>
            
            <div class="law-item" style="background: var(--black-card); padding: 0.2rem; border-radius: 2px; border-left: 2px solid var(--gold);">
                <h4 style="color: var(--gold); margin-bottom: 0rem; font-size: 1.2rem; font-weight: bold;">7. Leverage Amplification</h4>
                <p style="color: var(--gray-light); font-size: 1.1rem; line-height: 1; margin: 0;">Small inputs, massive outputs through leverage.</p>
            </div>
        </div>
...
function getDailyQuote(day) {
    const quotes = [
        ...
        '\"Build the new, don\'t fight the old.\" - Socrates',
...
function generateChapter3Do() {
    ...
    const uniqueQuotes = [
        ...
        { quote: "Success is going from failure to failure without losing your enthusiasm.", author: "Winston Churchill", lesson: "Resilience fuels long-term success.", reflection: "What enthusiasm will you maintain despite any challenges today?" },
...
function generateRewardCheckpoint(day, pageNumber) {
    const checkpoints = {
        ...
        60: {
            ...
            quote: "Systems create freedom. Habits create leverage. Power creates enemies.",
    ...
    <div class="page reward-checkpoint" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; padding: 0.5rem;">
        ...
        <div class="signature-section" style="text-align: center; margin: 1.5rem 0;">
            <p style="color: var(--gold); margin-bottom: 0.5rem; font-size: 1.1rem; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">Sign your name to claim this achievement:</p>
            <div style="border-bottom: 2px solid var(--gold); width: 320px; height: 2.5rem; margin: 0 auto 0.8rem; position: relative;">
                <span style="position: absolute; bottom: 0.2rem; left: 0; right: 0; text-align: center; color: var(--gold-light); font-size: 0.75rem; font-style: italic;">Sign here</span>
            </div>
            <p style="color: var(--gold-light); font-size: 0.9rem; margin: 0.8rem 0; font-weight: 500;">By signing, you commit to the next 30 days of transformation</p>
        </div>
...
function generateSabotageCheckpoint(day, pageNumber) {
    ...
    <div class="page" style="background: linear-gradient(135deg, rgba(255,100,0,0.05) 0%, rgba(255,255,255,1) 50%, rgba(255,100,0,0.05) 100%); border: 2px solid #ff6600; padding-top: -3mm;">
        ...
        <div class="page-number">${pageNumber}</div>
        <div class="footer-wisdom">"Conquer the enemy within." - Khamare Clarke</div>
    </div>`;
}
...
function generateBuilderSpotlight(day, pageNumber) {
    ...
    <div class="page" style="background: linear-gradient(135deg, rgba(212, 175, 55, 0.03) 0%, rgba(255,255,255,1) 50%, rgba(212, 175, 55, 0.03) 100%);">
        ...
        <div class="page-number">${pageNumber}</div>
        <div class="footer-wisdom">"Your transformation inspires others." - Khamare Clarke</div>
    </div>`;
}
...
function generateChapter5Legacy() {
    ...
    <div class="page certificate-page flex flex-col items-center justify-center">
        <div class="certificate-border" style="border: 3px solid var(--gold); padding: 1.5rem; border-radius: 15px; text-align: center; max-width: 500px;">
            ...
            <h1 style="color: var(--gold); font-size: 1.4rem; margin: 0.3rem 0 0.2rem 0; font-family: 'Cormorant Garamond', serif;">
                CERTIFICATE OF COMPLETION
            </h1>
            
            <div class="gold-line" style="width: 200px; margin: 0.2rem auto 0.5rem;"></div>
            
            <p style="color: var(--gray-light); margin: 0.2rem 0 0.8rem 0; line-height: 1.4; font-size: 0.85rem;">
                This certifies that
            </p>
            
            <div style="border-bottom: 3px solid var(--gold); padding: 1rem 0.8rem; margin: 0 auto 1rem auto; min-width: 350px; min-height: 50px; text-align: center; display: flex; align-items: center; justify-content: center;">
            ...
            <div style="margin: 1.5rem 0;">
                <p style="color: var(--gray); font-size: 0.8rem; margin-bottom: 0.5rem;">Completion Date:</p>
                <div style="border-bottom: 1px solid var(--gold-dark); padding: 0.6rem 0; margin: 0.6rem 0; min-width: 220px; min-height: 30px;">
...
function generateBackCover() {
    return `
    <!-- BACK COVER -->
    <div class="page cover-page" style="background: linear-gradient(135deg, var(--black) 0%, var(--black-soft) 50%, var(--black) 100%); padding: 0.4rem; padding-top: 0rem; margin-top: 1rem; box-sizing: border-box; display: flex; flex-direction: column; justify-content: flex-start; min-height: 100vh; transform: translateY(0); position: relative; top: 0;">
        
        <!-- MAIN HEADLINE -->
        <div class="back-headline" style="text-align: center; margin-bottom: 0.3rem; margin-top: 0.5rem;">
            ...
            <p style="color: var(--gold-light); font-size: 1rem; font-weight: 600; margin-bottom: 0; line-height: 1.4; font-style: italic;">
                A <strong>90-day framework</strong> built to make success predictable and inevitable.
            </p>
        </div>
        
        <!-- WHAT IT IS -->
        <div class="what-it-is" style="margin-bottom: 0.25rem; margin-top: 0.25rem; background: rgba(212, 175, 55, 0.08); padding: 0.35rem; border-radius: 10px; border: 1px solid rgba(212, 175, 55, 0.3);">
            ...
            <p style="color: var(--gray-light); font-size: 0.9rem; line-height: 1.1; text-align: center; max-width: 90%; margin: 0 auto;">
                Your personal HQ for discipline, focus, and execution. A streamlined system that turns goals into results.
            </p>
        </div>
        
        <!-- WHAT YOU GET -->
        <div class="what-you-get" style="margin-bottom: 0.25rem; margin-top: 0.25rem;">
            <h3 style="color: var(--gold); font-size: 1rem; margin-bottom: 0.2rem; text-align: center; font-weight: 700; letter-spacing: 0.3px;">INSIDE YOU GET</h3>
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 0.2rem; font-size: 0.9rem; max-width: 95%; margin: 0 auto;">
                ...
                <div style="color: var(--gray-light);">• <strong style="color: var(--gold-light);">Progress Tracking</strong></div>
                <div style="color: var(--gray-light);">• <strong style="color: var(--gold-light);">Builder's Guild Access</strong></div>
            </div>
        </div>
        
        <!-- RESULTS PROMISE -->
        <div class="results-promise" style="background: var(--black-card); padding: 0.35rem; border-radius: 12px; border: 2px solid var(--gold); margin-bottom: 0.25rem; margin-top: 0.25rem; text-align: center; box-shadow: 0 4px 20px rgba(212, 175, 55, 0.2);">
            <h3 style="color: var(--gold); font-size: 1.2rem; margin-bottom: 0.2rem; font-weight: 700; letter-spacing: 0.3px;">YOUR 90-DAY OUTCOME</h3>
            <div style="font-size: 1rem; color: var(--gray-light); line-height: 1.1;">
                <p style="margin-bottom: 0.1rem;">• <strong style="color: var(--gold-light);">Clarity</strong> on your direction</p>
                <p style="margin-bottom: 0.1rem;">• <strong style="color: var(--gold-light);">Habits</strong> that build momentum</p>
                <p style="margin-bottom: 0.1rem;">• <strong style="color: var(--gold-light);">Progress you can measure</strong></p>
                <p style="margin-bottom: 0;">• <strong style="color: var(--gold-light);">A community</strong> of builders</p>
            </div>
        </div>
        
        <!-- USP -->
        <div class="usp-section" style="text-align: center; margin-bottom: 0.25rem; margin-top: 0.25rem;">
            <div style="background: linear-gradient(135deg, var(--gold) 0%, var(--gold-metallic) 100%); padding: 0.3rem; border-radius: 12px; margin-bottom: 0.3rem; box-shadow: 0 2px 10px rgba(212, 175, 55, 0.2);">
                <p style="color: var(--black); font-weight: 700; font-size: 1rem; margin: 0; letter-spacing: 0.3px;">
                    Most people write goals. You'll build systems that make success unavoidable.
                </p>
            </div>
        </div>
        
        <!-- AUTHOR & QR -->
        <div class="bottom-section" style="display: flex; justify-content: space-between; align-items: center; margin-top: auto; padding-top: 0.6rem; border-top: 1px solid rgba(212, 175, 55, 0.3);">
            <div class="author-info">
                <p style="color: var(--gold-light); font-weight: 700; font-size: 0.9rem; margin-bottom: 0.05rem; letter-spacing: 0.2px;">Khamare Clarke</p>
                <p style="color: var(--gray); font-size: 0.75rem; margin: 0 0 0.05rem 0;">Founder, Leverage Systems</p>
                <p style="color: var(--gray); font-size: 0.75rem; margin: 0;">AI Empire Architect</p>
            </div>
...
function generateSuccessJourneyArc() {
    ...
    <div class="page">
        ...
        <div class="footer-wisdom">Every success starts with one decision.</div>
...
function generateHistoricalWisdomStories() {
    ...
    <div class="page">
        ...
        <div class="footer-wisdom">Find your leverage point.</div>
...
function generatePersonalReflectionPages() {
    ...
    <div class="page">
        ...
        <div class="footer-wisdom">Power moments reveal potential.</div>
...
function generateAdditionalStorytellingPages() {
    ...
    <div class="page">
        ...
        <div class="footer-wisdom">Great builders make great sacrifices.</div>
...
// HEALTH & WELLNESS INTEGRATION SYSTEM - Split into separate components
function generateEnergyManagementSystem(pageNumber) {
    return `
    <!-- ENERGY MANAGEMENT SYSTEM -->
    <div class="page" style="padding: 0.5rem 1rem;">
        <h1 class="text-center gold-gradient" style="font-size: 2rem; margin: 0.3rem 0;">Energy Management System</h1>
        <div class="gold-line" style="margin: 0.2rem 0 0.5rem 0;"></div>
        
        <div style="background: var(--black-card); padding: 0.8rem; border-radius: 8px; border: 1px solid var(--gold); margin: 0.8rem 0;">
            <h3 style="color: var(--gold); font-size: 1.1rem; margin: 0 0 0.5rem 0;">💡 The Energy Principle</h3>
            <p style="color: var(--gray-light); font-size: 0.85rem; line-height: 1.3; margin: 0 0 0.5rem 0;">Energy, not time, is your most valuable resource. Peak performers manage their energy across four dimensions: Physical, Emotional, Mental, and Spiritual.</p>
            <p style="color: var(--gold-light); font-size: 0.85rem; line-height: 1.3; font-weight: 600; margin: 0;">Master your energy, master your life.</p>
        </div>
        
        <h3 style="color: var(--gold); font-size: 1rem; margin: 0.3rem 0;">⚡ DAILY ENERGY AUDIT</h3>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.4rem; margin: 0 0 0.5rem 0;">
            <div style="background: rgba(212, 175, 55, 0.05); padding: 0.5rem; border-radius: 6px;">
                <h4 style="color: var(--gold-light); font-size: 0.8rem; margin: 0 0 0.2rem 0;">🏃 PHYSICAL ENERGY</h4>
                <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.1rem 0;">Sleep Quality (1-10):</p>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 14px; margin: 0 0 0.2rem 0;"></div>
                <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.1rem 0;">Exercise Today (Y/N):</p>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 14px;"></div>
            </div>
            <div style="background: rgba(212, 175, 55, 0.05); padding: 0.5rem; border-radius: 6px;">
                <h4 style="color: var(--gold-light); font-size: 0.8rem; margin: 0 0 0.2rem 0;">🧠 MENTAL ENERGY</h4>
                <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.1rem 0;">Focus Level (1-10):</p>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 14px; margin: 0 0 0.2rem 0;"></div>
                <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.1rem 0;">Deep Work Hours:</p>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 14px;"></div>
            </div>
        </div>
        
        <h3 style="color: var(--gold); font-size: 1rem; margin: 0.3rem 0 0.5rem 0;">🔋 ENERGY OPTIMIZATION</h3>
        <div style="background: rgba(212, 175, 55, 0.05); padding: 0.8rem; border-radius: 6px; margin-bottom: 0.5rem;">
            <p style="color: var(--gray-light); font-size: 0.8rem; margin: 0 0 0.4rem 0; font-weight: 500;">What gives you energy vs. what drains it?</p>
            <div style="display: flex; align-items: center; margin-bottom: 0.6rem;">
                <span style="color: var(--gold-light); font-size: 0.8rem; margin-right: 0.5rem;">1.</span>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 18px; flex-grow: 1;"></div>
            </div>
            <div style="display: flex; align-items: center; margin-bottom: 0.6rem;">
                <span style="color: var(--gold-light); font-size: 0.8rem; margin-right: 0.5rem;">2.</span>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 18px; flex-grow: 1;"></div>
            </div>
            <div style="display: flex; align-items: center; margin-bottom: 0.6rem;">
...
function generateMentalHealthProtocols(pageNumber) {
    return `
    <!-- MENTAL HEALTH PROTOCOLS -->
    <div class="page" style="padding: 0.5rem 1rem;">
        <h1 class="text-center gold-gradient" style="font-size: 1.8rem; margin: 0.2rem 0 0.3rem 0;">Mental Health Protocols</h1>
        <div class="gold-line" style="margin-bottom: 0.4rem;"></div>
        
        <div style="background: var(--black-card); padding: 0.8rem; border-radius: 8px; border: 2px solid var(--gold); margin: 0.5rem 0;">
            <h3 style="color: var(--gold); font-size: 1rem; margin-bottom: 0.4rem;">🧘 Marcus Aurelius' Mental Discipline</h3>
            <p style="color: var(--gray-light); font-size: 0.75rem; line-height: 1.3; margin-bottom: 0.4rem;">The Roman Emperor who ruled during plague and war wrote: "You have power over your mind - not outside events. Realize this, and you will find strength." He practiced daily mental hygiene through journaling and philosophical reflection.</p>
            <p style="color: var(--gold-light); font-size: 0.75rem; line-height: 1.3; font-weight: 600; margin: 0;">Mental strength is built through daily practice, not crisis management.</p>
        </div>
        
        <h3 style="color: var(--gold); font-size: 0.95rem; margin: 0.3rem 0 0.2rem 0;">🧠 STRESS MANAGEMENT SYSTEM</h3>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.4rem; margin-bottom: 0.5rem;">
            <div style="background: rgba(212, 175, 55, 0.05); padding: 0.5rem; border-radius: 6px;">
                <h4 style="color: var(--gold-light); font-size: 0.75rem; margin-bottom: 0.2rem;">⚠️ STRESS TRIGGERS</h4>
                <p style="color: var(--gray-light); font-size: 0.65rem; margin-bottom: 0.2rem;">Top 3 stress sources:</p>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 24px; margin-bottom: 0.15rem;"></div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 24px; margin-bottom: 0.15rem;"></div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 24px;"></div>
            </div>
            <div style="background: rgba(212, 175, 55, 0.05); padding: 0.5rem; border-radius: 6px;">
                <h4 style="color: var(--gold-light); font-size: 0.75rem; margin-bottom: 0.2rem;">🛡️ STRESS RESPONSES</h4>
                <p style="color: var(--gray-light); font-size: 0.65rem; margin-bottom: 0.2rem;">Healthy responses:</p>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 24px; margin-bottom: 0.15rem;"></div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 24px; margin-bottom: 0.15rem;"></div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 24px;"></div>
            </div>
        ...
        <h3 style="color: var(--gold); font-size: 0.95rem; margin: 0.3rem 0 0.2rem 0;">💚 EMOTIONAL REGULATION</h3>
        <div style="background: rgba(212, 175, 55, 0.05); padding: 0.6rem; border-radius: 6px;">
            <p style="color: var(--gray-light); font-size: 0.75rem; margin-bottom: 0.3rem;">Daily mood check: What emotion am I carrying today and why?</p>
        ...
        <div class="footer-wisdom" style="margin-top: 0.5rem;">The mind is everything. What you think, you become.</div>
        <div class="page-number">${pageNumber}</div>
    </div>`;
}

// FINANCIAL SUCCESS SYSTEMS
function generateFinancialSuccessSystems(startPageNumber = 60) {
    let currentPage = startPageNumber;
    return `
    <!-- FINANCIAL FOUNDATIONS -->
    <div class="page" style="padding-top: 0; padding-bottom: 0;">
        <h1 class="text-center" style="font-size: 1.7rem; margin: 0.05rem 0; color: black;">Financial Foundations</h1>
        <div class="gold-line" style="margin-bottom: 0.1rem;"></div>
        <div style="background: var(--black-card); padding: 0.3rem; border-radius: 6px; border: 1px solid var(--gold); margin: 0.05rem 0 0.2rem 0;">
            <h3 style="color: var(--gold); font-size: 1.2rem; margin: 0 0 0.2rem 0; line-height: 1.2;">💰 The Rockefeller Money System</h3>
            <p style="color: var(--gray-light); font-size: 0.8rem; line-height: 1.3; margin: 0 0 0.2rem 0;">John D. Rockefeller, America's first billionaire, tracked every penny and believed in "systematic giving, systematic saving, and systematic investing." He allocated his income with precision: 10% to giving, 20% to savings, and 70% to living expenses.</p>
            <p style="color: var(--gold-light); font-size: 0.8rem; line-height: 1.3; font-weight: 600; margin: 0; font-style: italic;">Money is a tool. Master it, or it will master you.</p>
        </div>
        
        <h3 style="color: var(--gold); font-size: 1.1rem; margin: 0.1rem 0; line-height: 1.1;">📊 PERSONAL FINANCE DASHBOARD</h3>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.3rem; margin-bottom: 0.3rem;">
            <div style="background: rgba(212, 175, 55, 0.05); padding: 0.3rem; border-radius: 6px; border: 1px solid rgba(212, 175, 55, 0.2);">
                <h4 style="color: var(--gold-light); font-size: 0.9rem; margin: 0 0 0.2rem 0; font-weight: 600;">📈 MONTHLY INCOME TRACKER</h4>
                <div style="display: grid; grid-template-columns: 1.5fr 1fr 1fr; gap: 0.2rem; margin-bottom: 0.2rem;">
                    <div style="font-size: 0.8rem; color: var(--gold); font-weight: 600;">Income Source</div>
                    <div style="font-size: 0.8rem; color: var(--gold); font-weight: 600; text-align: right;">Target</div>
                    <div style="font-size: 0.8rem; color: var(--gold); font-weight: 600; text-align: right;">Actual</div>
                </div>
                
                <div style="display: grid; grid-template-columns: 1.5fr 1fr 1fr; gap: 0.2rem; align-items: center; margin-bottom: 0.2rem;">
                    <div style="font-size: 0.8rem; color: var(--gray-light);">Active Income</div>
                    <div style="display: flex; align-items: center; justify-content: flex-end;">
                        <span class="currency-symbol" style="margin-right: 0.1rem; font-size: 0.8rem; color: var(--gold-light);">$</span>
                        <div style="border-bottom: 1px solid var(--gray-dark); height: 20px; flex-grow: 1; margin-left: 0.1rem;"></div>
                    </div>
                    <div style="display: flex; align-items: center; justify-content: flex-end;">
                        <span class="currency-symbol" style="margin-right: 0.15rem; font-size: 0.9rem; color: var(--gold-light);">$</span>
                        <div style="border-bottom: 1px solid var(--gray-dark); height: 22px; flex-grow: 1; margin-left: 0.15rem;"></div>
                    </div>
                </div>
                
                <div style="display: grid; grid-template-columns: 1.5fr 1fr 1fr; gap: 0.2rem; align-items: center; margin-bottom: 0.2rem;">
                    <div style="font-size: 0.8rem; color: var(--gray-light);">Passive Income</div>
                    <div style="display: flex; align-items: center; justify-content: flex-end;">
                        <span class="currency-symbol" style="margin-right: 0.1rem; font-size: 0.8rem; color: var(--gold-light);">$</span>
                        <div style="border-bottom: 1px solid var(--gray-dark); height: 20px; flex-grow: 1; margin-left: 0.1rem;"></div>
                    </div>
                ...
                <div style="display: grid; grid-template-columns: 1.5fr 1fr 1fr; gap: 0.2rem; align-items: center; margin-bottom: 0.2rem;">
                    <div style="font-size: 0.8rem; color: var(--gray-light);">Investment Returns</div>
                    <div style="display: flex; align-items: center; justify-content: flex-end;">
                        <span class="currency-symbol" style="margin-right: 0.1rem; font-size: 0.8rem; color: var(--gold-light);">$</span>
                        <div style="border-bottom: 1px solid var(--gray-dark); height: 20px; flex-grow: 1; margin-left: 0.1rem;"></div>
                    </div>
                ...
                <div style="margin-top: 0.2rem; display: flex; gap: 0.2rem; font-size: 0.7rem; color: var(--gold-light); align-items: center; border-top: 1px solid rgba(212, 175, 55, 0.2); padding-top: 0.2rem;">
                    <span style="font-weight: 500;">Currency:</span>
                    <label style="display: flex; align-items: center; gap: 0.1rem; cursor: pointer;">
                        <input type="radio" name="currency" value="$" checked style="accent-color: var(--gold); width: 10px; height: 10px;">
                        <span>$ USD</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.1rem; cursor: pointer;">
                        <input type="radio" name="currency" value="£" style="accent-color: var(--gold); width: 10px; height: 10px;">
                        <span>£ GBP</span>
                    </label>
                    <label style="display: flex; align-items: center; gap: 0.1rem; cursor: pointer;">
                        <input type="radio" name="currency" value="€" style="accent-color: var(--gold); width: 10px; height: 10px;">
            ...
            <div style="background: rgba(212, 175, 55, 0.05); padding: 0.3rem; border-radius: 6px; border: 1px solid rgba(212, 175, 55, 0.2);">
                <h4 style="color: var(--gold-light); font-size: 0.9rem; margin: 0 0 0.2rem 0; font-weight: 600;">📈 WEALTH BUILDING</h4>
                <p style="color: var(--gray-light); font-size: 0.8rem; margin: 0 0 0.1rem 0;">Monthly Investment:</p>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 20px; margin-bottom: 0.2rem;"></div>
                <p style="color: var(--gray-light); font-size: 0.8rem; margin: 0.1rem 0 0.1rem 0;">Net Worth Goal:</p>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 20px;"></div>
            </div>
        </div>
        
        <h3 style="color: var(--gold); font-size: 1rem; margin: 0.05rem 0; line-height: 1.1;">🎯 FINANCIAL FREEDOM PLAN</h3>
        <div style="background: rgba(212, 175, 55, 0.05); padding: 0.2rem; border-radius: 6px; margin-bottom: 0.2rem; border: 1px solid rgba(212, 175, 55, 0.2);">
            <p style="color: var(--gray-light); font-size: 0.8rem; margin: 0 0 0.05rem 0; font-weight: 500;">My 12-month financial goal:</p>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 20px; margin-bottom: 0.1rem;"></div>
            <p style="color: var(--gray-light); font-size: 0.8rem; margin: 0.05rem 0; font-weight: 500;">Steps to achieve it:</p>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 20px; margin-bottom: 0.1rem;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 20px;"></div>
        </div>
    ...
    <div class="page" style="padding: 0.7rem 1.2rem;">
        ...
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.7rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.6rem;">
            <h3 style="color: var(--gold); font-size: 1.1rem; margin: 0 0 0.3rem 0;">💡 Robert Kiyosaki's Cashflow Quadrant</h3>
            <p style="color: var(--gray-light); font-size: 0.85rem; line-height: 1.4; margin: 0 0 0.3rem 0;">The path to financial freedom is moving from the left side (Employee, Self-Employed) to the right side (Business Owner, Investor). The wealthy focus on building assets that generate passive income while they sleep.</p>
            <p style="color: var(--gold-light); font-size: 0.9rem; line-height: 1.4; font-weight: 600; margin: 0;">Don't work for money, make money work for you.</p>
        </div>
        
        <div style="font-size: 1rem; color: var(--gold); font-weight: 600; margin: 0.3rem 0 0.4rem;">🔄 INCOME STREAM DEVELOPMENT</div>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.3rem; margin-bottom: 0.4rem;">
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.4rem; border-radius: 4px;">
        ...
        <div style="font-size: 1rem; color: var(--gold); font-weight: 600; margin: 0.3rem 0 0.4rem;">📈 MONTHLY INCOME TRACKER</div>
        <div style="background: rgba(212, 175, 55, 0.02); padding: 0.4rem; border-radius: 4px;">
            <div style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 0.3rem; font-size: 0.8rem;">
                <div style="color: var(--gold-light); font-weight: 600; padding: 0.2rem 0;">Income Source</div>
                <div style="color: var(--gold-light); font-weight: 600; text-align: right; padding: 0.2rem 0;">Target</div>
                <div style="color: var(--gold-light); font-weight: 600; text-align: right; padding: 0.2rem 0;">Actual</div>
                
                <div style="padding: 0.2rem 0;">Active Income</div>
                <div style="text-align: right; padding: 0.2rem 0;">$<span style="display: inline-block; width: 90%; border-bottom: 1px solid var(--gray-dark);"></span></div>
                <div style="text-align: right; padding: 0.2rem 0;">$<span style="display: inline-block; width: 90%; border-bottom: 1px solid var(--gray-dark);"></span></div>
                
                <div style="padding: 0.2rem 0;">Passive Income</div>
                <div style="text-align: right; padding: 0.2rem 0;">$<span style="display: inline-block; width: 90%; border-bottom: 1px solid var(--gray-dark);"></span></div>
                <div style="text-align: right; padding: 0.2rem 0;">$<span style="display: inline-block; width: 90%; border-bottom: 1px solid var(--gray-dark);"></span></div>
                
                <div style="padding: 0.2rem 0;">Investment Returns</div>
                <div style="text-align: right; padding: 0.2rem 0;">$<span style="display: inline-block; width: 90%; border-bottom: 1px solid var(--gray-dark);"></span></div>
                <div style="text-align: right; padding: 0.2rem 0;">$<span style="display: inline-block; width: 90%; border-bottom: 1px solid var(--gray-dark);"></span></div>
            </div>
        </div>
...
// RELATIONSHIP & COMMUNICATION SYSTEMS
function generateRelationshipCommunicationSystems(startPageNumber = 131) {
    let currentPage = startPageNumber;
    return `
    <!-- NETWORK BUILDING SYSTEM -->
    <div class="page" style="padding: 0.7rem 1.2rem;">
        <h1 class="text-center" style="font-size: 1.6rem; margin: 0.3rem 0 0.4rem 0; color: black;">Network Building System</h1>
        <div class="gold-line" style="margin-bottom: 0.4rem;"></div>
        
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.7rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.6rem;">
            <h3 style="color: black; font-size: 1rem; margin: 0 0 0.3rem 0;">🤝 Reid Hoffman's Network Philosophy</h3>
            <p style="color: black; font-size: 0.8rem; line-height: 1.4; margin: 0 0 0.3rem 0;">The LinkedIn co-founder believes that professional networks are built on the "strength of weak ties" - often, it's your secondary connections that provide the most valuable opportunities. He advocates for a "pay it forward" approach to networking.</p>
            <p style="color: black; font-size: 0.85rem; line-height: 1.4; font-weight: 600; margin: 0;">The best way to grow your network is to help others grow theirs.</p>
        </div>
        
        <div style="font-size: 0.9rem; color: black; font-weight: 600; margin: 0.3rem 0 0.4rem;">🌐 NETWORK MAPPING</div>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.4rem; margin-bottom: 0.5rem;">
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.5rem; border-radius: 4px;">
                <div style="color: black; font-size: 0.8rem; font-weight: 600; margin-bottom: 0.3rem;">🔗 KEY CONNECTIONS</div>
                <div style="color: black; font-size: 0.8rem; margin-bottom: 0.2rem;">Mentors/Advisors:</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 40px; margin-bottom: 0.5rem;"></div>
                <div style="color: black; font-size: 0.8rem; margin-bottom: 0.2rem;">Peers/Allies:</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 40px;"></div>
            </div>
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.5rem; border-radius: 4px;">
                <div style="color: black; font-size: 0.8rem; font-weight: 600; margin-bottom: 0.3rem;">🎯 TARGET CONNECTIONS</div>
                <div style="color: black; font-size: 0.8rem; margin-bottom: 0.2rem;">People to meet this month:</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 40px; margin-bottom: 0.5rem;"></div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 40px;"></div>
            </div>
        </div>
        
        <h3 style="color: black; font-size: 1.1rem; margin: 0.4rem 0 0.5rem;">📅 RELATIONSHIP ACTIVITY</h3>
        <div style="background: rgba(212, 175, 55, 0.05); padding: 1rem; border-radius: 8px; margin-bottom: 1rem;">
            <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 0.6rem; font-size: 0.8rem;">
                <div style="color: black; font-weight: 600;">Action Item</div>
                <div style="color: black; font-weight: 600; text-align: right;">Date</div>
                
                <div style="color: black;">Follow up with:</div>
                <div style="text-align: right;"><span style="display: inline-block; width: 100%; border-bottom: 1px solid var(--gray-dark); height: 30px;"></span></div>
                
                <div style="color: black;">Introduce these people:</div>
                <div style="text-align: right;"><span style="display: inline-block; width: 100%; border-bottom: 1px solid var(--gray-dark); height: 30px;"></span></div>
                
                <div style="color: black;">Send thank you to:</div>
                <div style="text-align: right;"><span style="display: inline-block; width: 100%; border-bottom: 1px solid var(--gray-dark); height: 30px;"></span></div>
            </div>
        </div>
    ...
    <div class="page" style="padding: 0.7rem 1.2rem;">
        <h1 class="text-center" style="font-size: 1.8rem; margin: 0.3rem 0 0.4rem 0; color: black;">Communication Mastery</h1>
        <div class="gold-line" style="margin-bottom: 0.4rem;"></div>
        
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.7rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.6rem;">
            <h3 style="color: black; font-size: 1.1rem; margin: 0 0 0.3rem 0;">🗣️ Aristotle's Rhetoric</h3>
            <p style="color: black; font-size: 0.85rem; line-height: 1.4; margin: 0 0 0.3rem 0;">The ancient philosopher identified three pillars of persuasive communication: Ethos (credibility), Pathos (emotional connection), and Logos (logical argument). The most effective communicators balance all three elements to inspire action and build trust.</p>
            <p style="color: black; font-size: 0.85rem; line-height: 1.4; font-weight: 600; margin: 0;">The right word may be effective, but no word was ever as effective as a rightly timed pause.</p>
        </div>
        
        <div style="font-size: 1rem; color: black; font-weight: 600; margin: 0.3rem 0 0.4rem;">📝 COMMUNICATION AUDIT</div>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.4rem; margin-bottom: 0.5rem;">
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.5rem; border-radius: 4px;">
                <div style="color: black; font-size: 0.9rem; font-weight: 600; margin-bottom: 0.3rem;">🗨 VERBAL</div>
                <div style="color: black; font-size: 0.8rem; margin-bottom: 0.2rem;">Strength:</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 35px; margin-bottom: 0.4rem;"></div>
                <div style="color: black; font-size: 0.8rem; margin-bottom: 0.2rem;">Area to Improve:</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 35px;"></div>
            </div>
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.5rem; border-radius: 4px;">
                <div style="color: black; font-size: 0.9rem; font-weight: 600; margin-bottom: 0.3rem;">✍️ WRITTEN</div>
                <div style="color: black; font-size: 0.8rem; margin-bottom: 0.2rem;">Strength:</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 35px; margin-bottom: 0.4rem;"></div>
                <div style="color: black; font-size: 0.8rem; margin-bottom: 0.2rem;">Area to Improve:</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 35px;"></div>
        ...
        <div style="font-size: 1rem; color: black; font-weight: 600; margin: 0.3rem 0 0.4rem;">📞 CONVERSATION TRACKER</div>
        <div style="background: rgba(212, 175, 55, 0.02); padding: 0.5rem; border-radius: 4px;">
            <div style="color: black; font-size: 0.8rem; margin-bottom: 0.3rem;">Key conversations this week and follow-ups:</div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 35px; margin-bottom: 0.3rem;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 35px; margin-bottom: 0.3rem;"></div>
            <div style="display: flex; align-items: center; gap: 0.6rem;">
                <div style="color: black; font-size: 0.8rem;">Follow-up date:</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 30px; flex: 1;"></div>
            </div>
        </div>
        
        <div class="footer-wisdom" style="color: black;">Communication's greatest flaw: assuming it happened.</div>
        <div class="page-number">${currentPage + 1}</div>
    </div>
    
    <!-- RELATIONSHIP INTELLIGENCE -->
    <div class="page" style="padding: 0.3rem 0.8rem 0.5rem;">
        <h1 class="text-center" style="font-size: 1.6rem; margin: 0 0 0.1rem 0; color: black;">Relationship Intelligence</h1>
        <div class="gold-line" style="margin-bottom: 0.1rem;"></div>
        
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.4rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.2rem;">
            <h3 style="color: black; font-size: 1rem; margin: 0 0 0.1rem 0;">❤️ Dale Carnegie's Human Relations Principles</h3>
            <p style="color: black; font-size: 0.85rem; line-height: 1.2; margin: 0 0 0.1rem 0;">Carnegie's timeless advice in "How to Win Friends and Influence People" remains the gold standard for relationship building. His principles—like becoming genuinely interested in others, remembering names, and making others feel important—create lasting connections.</p>
            <p style="color: black; font-size: 0.85rem; line-height: 1.2; font-weight: 600; margin: 0;">You can make more friends in two months by becoming interested in other people than you can in two years by trying to get other people interested in you.</p>
        </div>
        
        <div style="font-size: 0.95rem; color: black; font-weight: 600; margin: 0.1rem 0;">🤍 EMOTIONAL INTELLIGENCE</div>
        <div style="background: rgba(212, 175, 55, 0.02); padding: 0.3rem; border-radius: 4px;">
            <div style="color: black; font-size: 0.8rem; margin-bottom: 0.05rem;">Current relationship to strengthen and how:</div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin-bottom: 0.2rem;"></div>
            <div style="color: black; font-size: 0.8rem; margin-bottom: 0.05rem;">Their current goals/challenges:</div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin-bottom: 0.2rem;"></div>
            <div style="color: black; font-size: 0.8rem; margin-bottom: 0.05rem;">How I can add value to them:</div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px;"></div>
        </div>
        
        <h3 style="color: black; font-size: 1.1rem; margin: 0.2rem 0 0.2rem;">📚 RELATIONSHIP RESOURCES</h3>
        <div style="background: rgba(212, 175, 55, 0.05); padding: 0.4rem; border-radius: 8px;">
            <p style="color: black; font-size: 0.85rem; margin-bottom: 0.2rem;">Books/Resources to explore:</p>
        ...
        <div class="footer-wisdom" style="color: black;">The quality of your life is the quality of your relationships.</div>
        <div class="page-number">${currentPage + 2}</div>
    </div>`;
}
...
function generateProductivityTimeMastery(startPageNumber = 132) {
    ...
    <div class="page" style="padding: 0.7rem 1.2rem;">
        <h1 class="text-center" style="font-size: 1.8rem; margin: 0.3rem 0 0.4rem 0; color: black;">Time Blocking System</h1>
        <div class="gold-line" style="margin-bottom: 0.4rem;"></div>
        
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.7rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.6rem;">
            <h3 style="color: black; font-size: 1.1rem; margin: 0 0 0.4rem 0; display: flex; align-items: center;">
                <span style="margin-right: 0.4rem;">⏰</span> Cal Newport's Deep Work Philosophy
            </h3>
            <p style="color: var(--gray-light); font-size: 0.85rem; line-height: 1.4; margin: 0 0 0.4rem 0;">The ability to perform deep work is becoming increasingly rare at exactly the same time it is becoming increasingly valuable. Deep work is the ability to focus without distraction on a cognitively demanding task.</p>
            <p style="color: var(--gold-light); font-size: 0.85rem; line-height: 1.4; font-weight: 600; font-style: italic; margin: 0;">A commitment to deep work is not a moral stance, but rather a pragmatic recognition that the ability to concentrate is a skill that gets things done.</p>
        </div>
        
        <div style="display: flex; align-items: center; margin: 0.3rem 0 0.4rem;">
            <span style="color: black; font-size: 1rem; font-weight: 600;">📅 TIME BLOCK PLANNER</span>
        </div>
        
        <div style="display: grid; grid-template-columns: 0.7fr 2fr 1.3fr; gap: 0.3rem; margin-bottom: 0.4rem;">
            <!-- Time Column -->
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.3rem; border-radius: 4px;">
                <div style="color: black; font-size: 0.8rem; text-align: center; padding: 0.2rem 0;">🕗 8-10</div>
                <div style="border: 1px solid var(--gray-dark); height: 38px; border-radius: 2px; margin-bottom: 0.2rem;"></div>
                <div style="color: black; font-size: 0.8rem; text-align: center; padding: 0.2rem 0;">🕙 10-12</div>
                <div style="border: 1px solid var(--gray-dark); height: 38px; border-radius: 2px; margin-bottom: 0.2rem;"></div>
                <div style="color: black; font-size: 0.8rem; text-align: center; padding: 0.2rem 0;">🕛 12-2</div>
                <div style="border: 1px solid var(--gray-dark); height: 38px; border-radius: 2px; margin-bottom: 0.2rem;"></div>
                <div style="color: black; font-size: 0.8rem; text-align: center; padding: 0.2rem 0;">🕑 2-4</div>
                <div style="border: 1px solid var(--gray-dark); height: 38px; border-radius: 2px; margin-bottom: 0.2rem;"></div>
                <div style="color: black; font-size: 0.8rem; text-align: center; padding: 0.2rem 0;">🕓 4-6</div>
                <div style="border: 1px solid var(--gray-dark); height: 38px; border-radius: 2px;"></div>
            </div>
            
            <!-- Weekly Grid -->
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.3rem; border-radius: 4px;">
                <div style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 0.2rem; margin-bottom: 0.2rem;">
                    <div style="text-align: center; font-size: 0.75rem; color: black; font-weight: 600; padding: 0.2rem 0; background: rgba(0,0,0,0.1); border-radius: 2px;">Mon</div>
                    <div style="text-align: center; font-size: 0.75rem; color: black; font-weight: 600; padding: 0.2rem 0; background: rgba(0,0,0,0.1); border-radius: 2px;">Tue</div>
                    <div style="text-align: center; font-size: 0.75rem; color: black; font-weight: 600; padding: 0.2rem 0; background: rgba(0,0,0,0.1); border-radius: 2px;">Wed</div>
                    <div style="text-align: center; font-size: 0.75rem; color: black; font-weight: 600; padding: 0.2rem 0; background: rgba(0,0,0,0.1); border-radius: 2px;">Thu</div>
                    <div style="text-align: center; font-size: 0.75rem; color: black; font-weight: 600; padding: 0.2rem 0; background: rgba(0,0,0,0.1); border-radius: 2px;">Fri</div>
                    <div style="text-align: center; font-size: 0.75rem; color: black; font-weight: 600; padding: 0.2rem 0; background: rgba(0,0,0,0.1); border-radius: 2px;">Sat</div>
                    <div style="text-align: center; font-size: 0.75rem; color: black; font-weight: 600; padding: 0.2rem 0; background: rgba(0,0,0,0.1); border-radius: 2px;">Sun</div>
                </div>
            ...
            <!-- Priority Matrix -->
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.3rem; border-radius: 4px;">
                <div style="text-align: center; font-size: 0.8rem; color: black; font-weight: 600; padding: 0.2rem 0; margin-bottom: 0.2rem; background: rgba(0,0,0,0.1); border-radius: 2px;">🎥 PRIORITY MATRIX</div>
                <div style="display: grid; grid-template-rows: repeat(4, 1fr); gap: 0.2rem; height: calc(100% - 30px);">
                    <!-- DO NOW -->
                    <div style="background: rgba(255, 77, 77, 0.05); padding: 0.3rem; border-radius: 2px; border: 1px solid rgba(255, 77, 77, 0.2);">
                        <div style="display: flex; align-items: center; margin-bottom: 0.2rem;">
                            <div style="width: 10px; height: 10px; background: #ff4d4d; border-radius: 2px; margin-right: 0.3rem;"></div>
                            <span style="color: black; font-size: 0.75rem; font-weight: 600;">DO NOW</span>
                        </div>
                        <p style="color: var(--gray-light); font-size: 0.7rem; font-style: italic; margin: 0;">Urgent & Important</p>
                    </div>
                    
                    <!-- SCHEDULE -->
                    <div style="background: rgba(76, 175, 80, 0.05); padding: 0.3rem; border-radius: 2px; border: 1px solid rgba(76, 175, 80, 0.2);">
                        <div style="display: flex; align-items: center; margin-bottom: 0.2rem;">
                            <div style="width: 10px; height: 10px; background: #4CAF50; border-radius: 2px; margin-right: 0.3rem;"></div>
                            <span style="color: black; font-size: 0.75rem; font-weight: 600;">SCHEDULE</span>
                        </div>
                        <p style="color: var(--gray-light); font-size: 0.7rem; font-style: italic; margin: 0;">Not Urgent but Important</p>
                    </div>
                    
                    <!-- DELEGATE -->
                    <div style="background: rgba(33, 150, 243, 0.05); padding: 0.3rem; border-radius: 2px; border: 1px solid rgba(33, 150, 243, 0.2);">
                        <div style="display: flex; align-items: center; margin-bottom: 0.2rem;">
                            <div style="width: 10px; height: 10px; background: #2196F3; border-radius: 2px; margin-right: 0.3rem;"></div>
                            <span style="color: black; font-size: 0.75rem; font-weight: 600;">DELEGATE</span>
                        </div>
                        <p style="color: var(--gray-light); font-size: 0.7rem; font-style: italic; margin: 0;">Urgent but Not Important</p>
                    </div>
                    
                    <!-- ELIMINATE -->
                    <div style="background: rgba(85, 85, 85, 0.05); padding: 0.3rem; border-radius: 2px; border: 1px solid rgba(85, 85, 85, 0.2);">
                        <div style="display: flex; align-items: center; margin-bottom: 0.2rem;">
                            <div style="width: 10px; height: 10px; background: #555; border-radius: 2px; margin-right: 0.3rem;"></div>
                            <span style="color: black; font-size: 0.75rem; font-weight: 600;">ELIMINATE</span>
                        </div>
                        <p style="color: var(--gray-light); font-size: 0.7rem; font-style: italic; margin: 0;">Not Urgent & Not Important</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="page" style="padding: 0.6rem 1rem;">
        <h1 class="text-center" style="font-size: 1.8rem; margin: 0.2rem 0 0.3rem 0; color: black;">Task Management</h1>
        <div class="gold-line" style="margin-bottom: 0.3rem;"></div>
        
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.6rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.4rem;">
            <h3 style="color: black; font-size: 1.1rem; margin: 0 0 0.2rem 0;">📝 David Allen's Getting Things Done</h3>
            <p style="color: var(--gray-light); font-size: 0.85rem; line-height: 1.3; margin: 0 0 0.2rem 0;">The GTD method provides a system for capturing all the things that need to get done—now, later, someday, big, little—into a logical system that helps you stay organized and focused. The core principles are: capture, clarify, organize, reflect, and engage.</p>
            <p style="color: var(--gold-light); font-size: 0.85rem; line-height: 1.3; font-weight: 600; margin: 0;">Your mind is for having ideas, not holding them.</p>
        </div>
        
        <div style="font-size: 1rem; color: black; font-weight: 600; margin: 0.2rem 0 0.3rem;">✅ WEEKLY TASKS</div>
        <div style="background: rgba(212, 175, 55, 0.02); padding: 0.3rem; border-radius: 4px;">
            <div style="display: grid; grid-template-columns: 1.2rem 1fr 2rem; gap: 0.2rem; margin-bottom: 0.2rem; align-items: center;">
                <div style="width: 16px; height: 16px; border: 1px solid var(--gold); border-radius: 2px;"></div>
                <div style="color: black; font-size: 0.8rem;">Task description</div>
                <div style="color: black; font-size: 0.75rem; text-align: right;">PRI</div>
            </div>
            ${Array(10).fill(`
            <div style="display: grid; grid-template-columns: 1.2rem 1fr 2rem; gap: 0.2rem; margin-bottom: 0.15rem; align-items: center;">
                <div style="width: 16px; height: 16px; border: 1px solid var(--gray-dark); border-radius: 2px;"></div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 22px;"></div>
                <div style="color: black; font-size: 0.75rem; text-align: right;">A/B/C</div>
            </div>`).join('')}
        </div>
        
        <h3 style="color: black; font-size: 1.3rem; margin: 0.3rem 0 0.2rem;">🔥 FOCUS SESSIONS</h3>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.4rem; margin-bottom: 0.6rem;">
            <div style="background: rgba(212, 175, 55, 0.05); padding: 0.6rem; border-radius: 8px;">
                <h4 style="color: black; font-size: 1rem; margin-bottom: 0.3rem;">⏱️ POMODORO TRACKER</h4>
                <div style="display: flex; justify-content: space-between; margin-bottom: 0.4rem;">
                    <span style="color: black; font-size: 0.85rem;">Focus:</span>
                    <span style="color: black; font-size: 0.85rem;">25:00</span>
                </div>
                <div style="height: 10px; background: var(--gray-dark); border-radius: 5px; margin-bottom: 0.4rem;">
                    <div style="width: 0%; height: 100%; background: var(--gold); border-radius: 5px;"></div>
                </div>
                <div style="display: flex; justify-content: space-between;">
                    <span style="color: black; font-size: 0.75rem;">Sessions: 0/4</span>
                    <span style="color: black; font-size: 0.75rem;">Break: 5:00</span>
                </div>
            </div>
            <div style="background: rgba(212, 175, 55, 0.05); padding: 0.6rem; border-radius: 8px;">
                <h4 style="color: black; font-size: 1rem; margin-bottom: 0.3rem;">📊 FOCUS METRICS</h4>
                <div style="margin-bottom: 0.4rem;">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 0.2rem;">
                        <span style="color: black; font-size: 0.85rem;">Deep Work Hours:</span>
                        <span style="color: black; font-size: 0.85rem;">0/15</span>
                    </div>
                    <div style="height: 8px; background: var(--gray-dark); border-radius: 4px;">
                        <div style="width: 0%; height: 100%; background: var(--gold); border-radius: 4px;"></div>
                    </div>
                </div>
                <div>
                    <div style="display: flex; justify-content: space-between; margin-bottom: 0.2rem;">
                        <span style="color: black; font-size: 0.85rem;">Tasks Completed:</span>
                        <span style="color: black; font-size: 0.85rem;">0/8</span>
                    </div>
                    <div style="height: 8px; background: var(--gray-dark); border-radius: 4px;">
                        <div style="width: 0%; height: 100%; background: var(--gold); border-radius: 4px;"></div>
                    </div>
    ...
    <!-- ENERGY OPTIMIZATION -->
    <div class="page" style="padding: 0.4rem 0.8rem 0.6rem;">
        <h1 class="text-center" style="font-size: 1.7rem; margin: 0 0 0.2rem 0; color: black;">Energy Optimization</h1>
        <div class="gold-line" style="margin-bottom: 0.2rem;"></div>
        
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.5rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.3rem;">
            <h3 style="color: black; font-size: 1.1rem; margin: 0 0 0.2rem 0;">⚡ The 90-Minute Work Cycle</h3>
            <p style="color: black; font-size: 0.85rem; line-height: 1.3; margin: 0 0 0.2rem 0;">Research shows that our brains naturally move through cycles of high and low alertness approximately every 90 minutes. By aligning work sessions with these ultradian rhythms, you can maximize productivity and minimize fatigue.</p>
            <p style="color: black; font-size: 0.85rem; line-height: 1.3; font-weight: 600; margin: 0;">Energy, not time, is the fundamental currency of high performance.</p>
        </div>
        
        <div style="font-size: 1rem; color: black; font-weight: 600; margin: 0.1rem 0 0.2rem;">🌡️ ENERGY LEVEL TRACKER</div>
        <div style="background: rgba(212, 175, 55, 0.02); padding: 0.3rem; border-radius: 4px;">
            <div style="display: grid; grid-template-columns: 0.8fr 2fr 0.8fr; gap: 0.3rem; font-size: 0.8rem;">
                <div style="color: black; font-weight: 600; padding: 0.1rem 0;">Time</div>
                <div style="color: black; font-weight: 600; padding: 0.1rem 0;">Activity</div>
                <div style="color: black; font-weight: 600; padding: 0.1rem 0;">Energy</div>
                
                ${Array(8).fill(`
                <div style="padding: 0.1rem 0; color: black;">__:__</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 24px;"></div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 24px;"></div>`).join('')}
            </div>
        </div>
        
        <h3 style="color: black; font-size: 1.2rem; margin: 0.2rem 0 0.3rem;">🔄 RECOVERY RITUALS</h3>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.4rem; margin-bottom: 0.5rem;">
            <div style="background: rgba(212, 175, 55, 0.05); padding: 0.4rem; border-radius: 8px;">
                <h4 style="color: black; font-size: 0.95rem; margin-bottom: 0.2rem;">☕ MICRO-BREAKS</h4>
                <p style="color: black; font-size: 0.85rem; margin-bottom: 0.2rem;">Every 25-30 mins:</p>
                <ul style="color: black; font-size: 0.85rem; padding-left: 0.8rem; margin: 0;">
            ...
            <div style="background: rgba(212, 175, 55, 0.05); padding: 0.4rem; border-radius: 8px;">
                <h4 style="color: black; font-size: 0.95rem; margin-bottom: 0.2rem;">🧘 ENERGY RECHARGE</h4>
                <p style="color: black; font-size: 0.85rem; margin-bottom: 0.2rem;">Every 90-120 mins:</p>
                <ul style="color: black; font-size: 0.85rem; padding-left: 0.8rem; margin: 0;">
                    <li>5-min walk</li>
                    <li>Hydrate</li>
...
function generateSkillsLearningSystem(startPageNumber = 42) {
    ...
    <div class="page" style="padding: 0.2rem 0.7rem 0.4rem;">
        <h1 class="text-center" style="font-size: 1.5rem; margin: 0 0 0.1rem 0; color: black;">Knowledge Management</h1>
        <div class="gold-line" style="margin-bottom: 0.1rem;"></div>
        
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.3rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.2rem;">
            <h3 style="color: black; font-size: 0.9rem; margin: 0 0 0.1rem 0;">🗃️ The Zettelkasten Method</h3>
            <p style="color: black; font-size: 0.75rem; line-height: 1.2; margin: 0;">Developed by Niklas Luhmann, the Zettelkasten (slip-box) method creates interconnected notes. Each note contains one idea linked to related notes, creating a knowledge web.</p>
        </div>
        
        <!-- BOOKS SECTION -->
        <div style="margin-bottom: 0.2rem;">
            <div style="font-size: 0.9rem; color: black; font-weight: 600; margin: 0 0 0.1rem;">📖 BOOKS TO READ</div>
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.3rem; border-radius: 4px;">
                <!-- Book 1 -->
                <div style="margin-bottom: 0.25rem;">
                    <div style="display: flex; align-items: center; margin-bottom: 0.1rem;">
                        <span style="color: black; font-size: 0.75rem; width: 45px;">Title:</span>
                        <div style="border-bottom: 1px solid var(--gray-dark); height: 24px; flex-grow: 1;"></div>
                    </div>
                    <div style="display: flex; align-items: center;">
                        <span style="color: black; font-size: 0.75rem; width: 45px;">Author:</span>
                        <div style="border-bottom: 1px solid var(--gray-dark); height: 24px; flex-grow: 1;"></div>
                    </div>
                </div>
        ...
        <div style="margin-bottom: 0.2rem;">
            <div style="font-size: 0.9rem; color: black; font-weight: 600; margin: 0 0 0.1rem;">💡 IDEAS & INSIGHTS</div>
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.3rem; border-radius: 4px;">
                <div style="color: black; font-size: 0.75rem; margin-bottom: 0.05rem;">Capture one key insight (what did you learn?):</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 25px; margin-bottom: 0.2rem;"></div>
                <div style="color: black; font-size: 0.75rem; margin-bottom: 0.05rem;">How can you apply this knowledge?</div>
                <div style="border-bottom: 1px solid var(--gray-dark); height: 25px; margin-bottom: 0.2rem;"></div>
                <div style="display: flex; align-items: center; gap: 0.2rem;">
                    <span style="color: black; font-size: 0.75rem;">Tags:</span>
                    <div style="border-bottom: 1px solid var(--gray-dark); height: 18px; flex-grow: 1;"></div>
                </div>
            </div>
        </div>
        ...
        <div>
            <div style="font-size: 0.9rem; color: black; font-weight: 600; margin: 0 0 0.1rem;">🔗 KNOWLEDGE CONNECTIONS</div>
            <div style="background: rgba(212, 175, 55, 0.02); padding: 0.3rem; border-radius: 4px;">
                <div style="margin-bottom: 0.2rem;">
                    <div style="color: black; font-size: 0.75rem; margin-bottom: 0.05rem;">Main topic or concept you're exploring:</div>
                    <div style="border-bottom: 1px solid var(--gray-dark); height: 25px;"></div>
                </div>
                <div>
                    <div style="color: black; font-size: 0.75rem; margin-bottom: 0.05rem;">How does this connect to your existing knowledge?</div>
                    <div style="border-bottom: 1px solid var(--gray-dark); height: 25px; margin-bottom: 0.2rem;"></div>
                    <div style="color: black; font-size: 0.75rem; margin-bottom: 0.05rem;">Related topic or idea to explore next:</div>
                    <div style="border-bottom: 1px solid var(--gray-dark); height: 25px;"></div>
                </div>
            </div>
        </div>
        
        <div class="footer-wisdom" style="color: black;">Knowledge is of no value unless you put it into practice.</div>
        <div class="page-number">${currentPage + 2}</div>
    </div>`;
}
...
const HISTORICAL_WISDOM = [
    // Western Classical Wisdom
    {
        quote: "The obstacle is the way. What stands in the way becomes the way.",
        author: "Marcus Aurelius",
        story: "Written during wartime, this Stoic principle shows how challenges can be transformed into opportunities."
    },
    {
        quote: "We are what we repeatedly do. Excellence is not an act, but a habit.",
        author: "Aristotle (Ancient Greece, 384-322 BCE)",
        story: "Developed while tutoring Alexander the Great, this principle became the foundation of Western virtue ethics and modern habit formation psychology."
    },
    
    // Eastern Philosophy
    {
        quote: "The journey of a thousand miles begins with a single step.",
        author: "Lao Tzu (Ancient China, 6th century BCE)",
        story: "The founder of Taoism wrote this while abandoning his position as royal archivist to pursue wisdom in solitude, creating a philosophy that would influence Chinese culture for 2,500 years."
    },
    {
        quote: "In the midst of chaos, there is also opportunity.",
        author: "Sun Tzu (Ancient China, 544-496 BCE)",
        story: "Written during the turbulent Warring States period, these strategic principles from 'The Art of War' have guided military, business, and political leaders across millennia and cultures."
    },
    
    // African Wisdom
    {
        quote: "If you want to go quickly, go alone. If you want to go far, go together.",
        author: "African Proverb (Ubuntu Philosophy)",
        story: "This principle of 'Ubuntu' (humanity toward others) guided Nelson Mandela's approach to reconciliation after 27 years of imprisonment, helping transform South Africa without civil war."
    },
    {
        quote: "Until the lion tells his story, the hunt always glorifies the hunter.",
        author: "Ewe-Mina Proverb",
        story: "A powerful reminder to seek multiple perspectives and question dominant narratives."
    },
    
    // Middle Eastern/Islamic Wisdom
    {
        quote: "Knowledge is a treasure, but practice is the key to it.",
        author: "Ibn Khaldun (Tunisia, 1332-1406)",
        story: "The father of sociology and economics wrote this while developing groundbreaking theories on social cohesion during the turbulent post-Mongol invasion period of North Africa."
    },
    {
        quote: "The wound is the place where the Light enters you.",
        author: "Rumi (Persia, 1207-1273)",
        story: "Written after losing his spiritual mentor, Rumi transformed profound grief into the world's most beloved mystical poetry, showing how suffering can become transcendence."
    },
    
    // Asian Wisdom Beyond China
    {
        quote: "Fall seven times, stand up eight.",
        author: "Japanese Proverb (Bushido Code)",
        story: "This principle from the Samurai warrior code guided Japan through centuries of challenges, including its remarkable post-WWII economic reconstruction."
    },
    {
    ...
    // Indigenous Wisdom
    {
        ...
        author: "Native American Proverb (Attributed to Chief Seattle)",
        story: "This wisdom reflects indigenous sustainability practices that maintained ecological balance for centuries."
    },
    {
        quote: "To know the road ahead, ask those coming back.",
        author: "Chinese Proverb (Confucian Tradition)",
        story: "This principle of respecting elders' wisdom has guided Chinese civilization through 5,000 years of continuous cultural development."
    },
    
    // Modern Transformational Leaders
    {
        quote: "It always seems impossible until it's done.",
        author: "Nelson Mandela (South Africa, 1918-2013)",
        story: "Written in secret while imprisoned for 27 years, these words later guided his transformation from prisoner to president and his nation from apartheid to democracy."
    },
    {
        quote: "Be the change you wish to see in the world.",
        author: "Mahatma Gandhi (India, 1869-1948)",
        story: "Gandhi's philosophy of nonviolent resistance liberated India and inspired global civil rights movements."
    },
    {
        quote: "The future belongs to those who believe in the beauty of their dreams.",
        author: "Eleanor Roosevelt (USA, 1884-1962)",
        story: "From a childhood of rejection and loss, Roosevelt became the architect of the Universal Declaration of Human Rights, transforming international human rights standards forever."
    }
];
...
function generateChapter3Stories(pageNumber, day) {
    const stories = [
        ...
        },
        {
            ...
            wisdom: "Perfection is achieved not when there's nothing to add, but nothing to take away."
        },
        {
    ...
    <div class="page">
        <h1 class="text-center" style="font-size: 2.3rem; color: black;">${currentStory.title}</h1>
        <div class="gold-line"></div>
...
function generateChapter4Stories() {
    ...
    <div class="page" style="padding: 0.3rem 0.8rem 0.5rem;">
        <h1 class="text-center" style="font-size: 1.8rem; margin: 0 0 0.1rem 0; color: black;">The Master's Reflection</h1>
        <div class="gold-line" style="margin-bottom: 0.1rem;"></div>
        
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.5rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.3rem;">
            <h3 style="color: black; font-size: 1.1rem; margin: 0 0 0.2rem 0;">🎨 Ray Dalio's Principles</h3>
            <p style="color: black; font-size: 0.85rem; line-height: 1.3; margin: 0 0 0.2rem 0;">After losing everything in 1982, Ray Dalio started writing down every decision and its outcome. He called it his "mistake log." This simple practice turned Bridgewater into the world's largest hedge fund.</p>
            <p style="color: black; font-size: 0.85rem; line-height: 1.3; margin: 0 0 0.2rem 0;">"Pain + Reflection = Progress." He realized that mistakes weren't failures-they were data points for improvement.</p>
            <p style="color: black; font-size: 0.85rem; line-height: 1.3; font-weight: 600; margin: 0;">The unexamined life is not worth living. The examined life becomes extraordinary.</p>
        </div>
        
        <div style="font-size: 1rem; color: black; font-weight: 600; margin: 0.2rem 0 0.2rem;">🔍 YOUR PATTERN RECOGNITION</div>
        <div style="background: rgba(212, 175, 55, 0.02); padding: 0.4rem; border-radius: 4px;">
            <div style="color: black; font-size: 0.85rem; margin-bottom: 0.2rem;">What patterns have you discovered about your success and failure?</div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 30px; margin-bottom: 0.2rem;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 30px; margin-bottom: 0.2rem;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 30px;"></div>
        </div>
...
function generateChapter5Stories() {
    ...
    <div class="page" style="padding: 0.3rem 0.8rem 0.5rem;">
        <h1 class="text-center" style="font-size: 1.8rem; margin: 0 0 0.1rem 0; color: black;">The Master's Journey</h1>
        <div class="gold-line" style="margin-bottom: 0.1rem;"></div>
        
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.5rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.3rem;">
            <h3 style="color: black; font-size: 1.1rem; margin: 0 0 0.2rem 0;">🎭 Leonardo da Vinci's Notebooks</h3>
            <p style="color: black; font-size: 0.85rem; line-height: 1.3; margin: 0 0 0.2rem 0;">Leonardo filled over 13,000 pages of notebooks with ideas, observations, and experiments. He wrote backwards in mirror script, making them hard to read-perhaps protecting his insights. His notebooks reveal a mind that saw connections everywhere: art, science, engineering, anatomy.</p>
            <p style="color: black; font-size: 0.85rem; line-height: 1.3; font-weight: 600; margin: 0;">Mastery isn't reaching a destination. It's becoming a perpetual student of your craft.</p>
        </div>
        
        <div style="font-size: 1rem; color: black; font-weight: 600; margin: 0.2rem 0 0.2rem;">🎨 YOUR MASTERY PATH</div>
        <div style="background: rgba(212, 175, 55, 0.02); padding: 0.4rem; border-radius: 4px;">
            <div style="color: black; font-size: 0.85rem; margin-bottom: 0.2rem;">What skills will you spend the next decade mastering?</div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 30px; margin-bottom: 0.2rem;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 30px; margin-bottom: 0.2rem;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 30px;"></div>
        </div>
...
function generateDecisionMakingRisk(startPageNumber = 221) {
    let currentPage = startPageNumber;
    return `
    <!-- STRATEGIC RISK ASSESSMENT & COUNTER-TACTICS -->
    <div class="page" style="padding-top: 0.5rem;">
        <h1 class="text-center" style="font-size: 1.9rem; margin: 0 0 0.3rem 0; color: black;">STRATEGIC RISK ASSESSMENT</h1>
        <div class="gold-line" style="margin-bottom: 0.4rem;"></div>
        
        <div style="background: var(--black-card); padding: 0.7rem; border-radius: 8px; border: 2px solid var(--gold); margin-bottom: 0.7rem;">
            <h3 style="color: var(--gold); font-size: 1.1rem; margin: 0 0 0.6rem 0; display: flex; align-items: center; gap: 0.4rem;">
                <span style="font-size: 1.2rem;">🔥</span> MACHIAVELLIAN RISK FRAMEWORK
            </h3>
            <p style="color: var(--gray-light); font-size: 0.8rem; line-height: 1.4; margin: 0 0 0.5rem 0; font-style: italic;">
                "There is nothing more difficult to take in hand, more perilous to conduct, or more uncertain in its success, than to take the lead in the introduction of a new order of things." - Machiavelli
            </p>
            <p style="color: var(--gold-light); font-size: 0.8rem; line-height: 1.4; font-weight: 600; margin: 0;">
                The Prince's wisdom: Anticipate opposition and neutralize it before it materializes.
            </p>
        </div>
        
        <h3 style="color: var(--gold); font-size: 1rem; margin: 0.4rem 0 0.4rem; padding-bottom: 0.2rem; border-bottom: 1px solid rgba(212, 175, 55, 0.3); display: flex; align-items: center; gap: 0.4rem;">
            <span style="font-size: 1.1rem;">🛡️</span> OPPOSITION MAPPING & COUNTER-TACTICS
        </h3>
        
        <!-- Advanced Opposition Mapping Grid -->
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; margin-bottom: 0.6rem;">
            <!-- Column 1: Opponent Types -->
            <div>
                <div style="background: rgba(255, 59, 48, 0.08); padding: 0.6rem; border-radius: 6px; border-left: 2px solid #FF3B30; margin-bottom: 0.6rem;">
                    <h4 style="color: #FF3B30; font-size: 0.85rem; margin: 0 0 0.3rem 0; display: flex; align-items: center; gap: 0.3rem;">
                        <span style="font-size: 1rem;">⚔️</span> Direct Opponents
                    </h4>
                    <div style="border-bottom: 1px solid rgba(255, 59, 48, 0.3); height: 1.2rem; margin-bottom: 0.2rem;"></div>
                    <p style="color: var(--gold-light); font-size: 0.75rem; margin: 0.2rem 0 0 0; font-weight: 500;">Counter: Overwhelm or convert</p>
                </div>
                
                <div style="background: rgba(255, 149, 0, 0.08); padding: 0.6rem; border-radius: 6px; border-left: 2px solid #FF9500; margin-bottom: 0.6rem;">
                    <h4 style="color: #FF9500; font-size: 0.85rem; margin: 0 0 0.3rem 0; display: flex; align-items: center; gap: 0.3rem;">
                        <span style="font-size: 1rem;">🦊</span> Covert Saboteurs
                    </h4>
                    <div style="border-bottom: 1px solid rgba(255, 149, 0, 0.3); height: 1.2rem; margin-bottom: 0.2rem;"></div>
                    <p style="color: var(--gold-light); font-size: 0.75rem; margin: 0.2rem 0 0 0; font-weight: 500;">Counter: Expose or redirect</p>
                </div>
            </div>
            
            <!-- Column 2: More Opponent Types -->
            <div>
                <div style="background: rgba(52, 199, 89, 0.08); padding: 0.6rem; border-radius: 6px; border-left: 2px solid #34C759; margin-bottom: 0.6rem;">
                    <h4 style="color: #34C759; font-size: 0.85rem; margin: 0 0 0.3rem 0; display: flex; align-items: center; gap: 0.3rem;">
                        <span style="font-size: 1rem;">🧩</span> Systemic Obstacles
                    </h4>
                    <div style="border-bottom: 1px solid rgba(52, 199, 89, 0.3); height: 1.2rem; margin-bottom: 0.2rem;"></div>
                    <p style="color: var(--gold-light); font-size: 0.75rem; margin: 0.2rem 0 0 0; font-weight: 500;">Counter: Bypass or transform</p>
                </div>
                
                <div style="background: rgba(0, 122, 255, 0.08); padding: 0.6rem; border-radius: 6px; border-left: 2px solid #007AFF;">
                    <h4 style="color: #007AFF; font-size: 0.85rem; margin: 0 0 0.3rem 0; display: flex; align-items: center; gap: 0.3rem;">
                        <span style="font-size: 1rem;">🎭</span> False Allies
                    </h4>
                    <div style="border-bottom: 1px solid rgba(0, 122, 255, 0.3); height: 1.2rem; margin-bottom: 0.2rem;"></div>
                    <p style="color: var(--gold-light); font-size: 0.75rem; margin: 0.2rem 0 0 0; font-weight: 500;">Counter: Test or compartmentalize</p>
                </div>
            </div>
        </div>
        
        <!-- Preemptive Tactics -->
        <h3 style="color: var(--gold); font-size: 1rem; margin: 0.6rem 0 0.4rem; padding-bottom: 0.2rem; border-bottom: 1px solid rgba(212, 175, 55, 0.3); display: flex; align-items: center; gap: 0.4rem;">
            <span style="font-size: 1.1rem;">💼</span> PREEMPTIVE POWER MOVES
        </h3>
        <div style="background: rgba(212, 175, 55, 0.08); padding: 0.5rem; border-radius: 6px; border: 1px solid rgba(212, 175, 55, 0.2);">
            <div style="display: flex; margin-bottom: 0.5rem; align-items: center;">
                <div style="width: 55%; color: var(--gold-light); font-size: 0.8rem; font-weight: 500;">1. Strategic Alliances:</div>
                <div style="width: 45%; border-bottom: 1px solid var(--gold-light); height: 1.1rem; margin-left: 0.3rem;"></div>
            </div>
            <div style="display: flex; margin-bottom: 0.5rem; align-items: center;">
                <div style="width: 55%; color: var(--gold-light); font-size: 0.8rem; font-weight: 500;">2. Information Control:</div>
                <div style="width: 45%; border-bottom: 1px solid var(--gold-light); height: 1.1rem; margin-left: 0.3rem;"></div>
            </div>
            <div style="display: flex; align-items: center;">
                <div style="width: 55%; color: var(--gold-light); font-size: 0.8rem; font-weight: 500;">3. Position Leverage:</div>
                <div style="width: 45%; border-bottom: 1px solid var(--gold-light); height: 1.1rem; margin-left: 0.3rem;"></div>
            </div>
        </div>
    ...
    <div class="page" style="padding: 0.5rem 1rem 0.3rem;">
        <h1 class="text-center" style="font-size: 1.8rem; margin: 0.1rem 0 0.3rem; font-weight: 700; color: black; letter-spacing: -0.3px;">Decision Framework Matrix</h1>
        <div class="gold-line" style="margin-bottom: 0.5rem; height: 0.5px; background: linear-gradient(90deg, transparent, var(--gold), transparent);"></div>
        
        <div style="background: var(--black-card); padding: 0.6rem; border-radius: 5px; border: 1px solid var(--gold); margin-bottom: 0.6rem; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
            <h3 style="color: var(--gold); font-size: 1rem; margin: 0 0 0.4rem 0; display: flex; align-items: center; gap: 0.3rem;">
                <span style="font-size: 1.2rem;">⚖️</span> Munger's Mental Models
            </h3>
            <p style="color: var(--gray-light); font-size: 0.78rem; line-height: 1.3; margin: 0 0 0.3rem 0; font-style: italic;">
                "You must know the big ideas in the big disciplines and use them routinely."
            </p>
            <p style="color: var(--gold-light); font-size: 0.8rem; font-weight: 600; margin: 0; text-align: center; padding: 0.3rem; background: rgba(212, 175, 55, 0.1); border-radius: 2px;">
                Good decisions compound. Bad decisions compound faster.
            </p>
        </div>
        
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; margin: 0.5rem 0 0;">
            <div style="background: rgba(0, 122, 255, 0.08); padding: 0.6rem; border-radius: 5px; border-left: 2px solid #007AFF; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
                <h4 style="color: #007AFF; font-size: 0.85rem; margin: 0 0 0.3rem 0; display: flex; align-items: center; gap: 0.2rem;">
                    <span style="font-size: 1rem;">🎯</span> Define
                </h4>
                <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.4rem 0; line-height: 1.25;">
                    What exactly am I deciding?
                </p>
                <div style="border-bottom: 1px solid rgba(0, 122, 255, 0.3); height: 1.2rem;"></div>
            </div>
            
            <div style="background: rgba(255, 59, 48, 0.08); padding: 0.6rem; border-radius: 5px; border-left: 2px solid #FF3B30; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
                <h4 style="color: #FF3B30; font-size: 0.85rem; margin: 0 0 0.3rem 0; display: flex; align-items: center; gap: 0.2rem;">
                    <span style="font-size: 1rem;">⚠️</span> Risks
                </h4>
                <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.4rem 0; line-height: 1.25;">
                    What could go wrong?
                </p>
                <div style="border-bottom: 1px solid rgba(255, 59, 48, 0.3); height: 1.2rem;"></div>
            </div>
            
            <div style="background: rgba(52, 199, 89, 0.08); padding: 0.6rem; border-radius: 5px; border-left: 2px solid #34C759; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
                <h4 style="color: #34C759; font-size: 0.85rem; margin: 0 0 0.3rem 0; display: flex; align-items: center; gap: 0.2rem;">
                    <span style="font-size: 1rem;">🚀</span> Success
                </h4>
                <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.4rem 0; line-height: 1.25;">
                    Best possible outcome?
                </p>
                <div style="border-bottom: 1px solid rgba(52, 199, 89, 0.3); height: 1.2rem;"></div>
            </div>
            
            <div style="background: rgba(255, 149, 0, 0.08); padding: 0.6rem; border-radius: 5px; border-left: 2px solid #FF9500; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
                <h4 style="color: #FF9500; font-size: 0.85rem; margin: 0 0 0.3rem 0; display: flex; align-items: center; gap: 0.2rem;">
                    <span style="font-size: 1rem;">🔄</span> Alternatives
                </h4>
                <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.4rem 0; line-height: 1.25;">
                    What else could I do?
                </p>
                <div style="border-bottom: 1px solid rgba(255, 149, 0, 0.3); height: 1.2rem;"></div>
            </div>
        </div>

        <div style="margin: 0.6rem 0 0.5rem;">
            <h3 style="color: var(--gold); font-size: 1rem; margin: 0 0 0.4rem 0; padding-bottom: 0.3rem; border-bottom: 1px solid rgba(212, 175, 55, 0.2); display: flex; align-items: center; gap: 0.3rem;">
                <span style="font-size: 1.1rem;">🔍</span> Key Mental Models
            </h3>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.4rem;">
                <div style="background: rgba(0, 0, 0, 0.15); padding: 0.5rem; border-radius: 4px; border-left: 2px solid var(--gold); box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
                    <p style="color: var(--gold-light); font-size: 0.8rem; margin: 0 0 0.1rem 0; font-weight: 600; display: flex; align-items: center;">
                        <span style="color: var(--gold); font-size: 0.9rem; margin-right: 0.3rem;">→</span> Inversion
                    </p>
                    <p style="color: var(--gray-light); font-size: 0.7rem; margin: 0; line-height: 1.2;">Think backwards from failure to identify critical risks</p>
                </div>
                
                <div style="background: rgba(0, 0, 0, 0.15); padding: 0.5rem; border-radius: 4px; border-left: 2px solid var(--gold); box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
                    <p style="color: var(--gold-light); font-size: 0.8rem; margin: 0 0 0.1rem 0; font-weight: 600; display: flex; align-items: center;">
                        <span style="color: var(--gold); font-size: 0.9rem; margin-right: 0.3rem;">→</span> Second-Order
                    </p>
                    <p style="color: var(--gray-light); font-size: 0.7rem; margin: 0; line-height: 1.2;">Consider long-term and indirect consequences</p>
                </div>
                
                <div style="background: rgba(0, 0, 0, 0.15); padding: 0.5rem; border-radius: 4px; border-left: 2px solid var(--gold); box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
                    <p style="color: var(--gold-light); font-size: 0.8rem; margin: 0 0 0.1rem 0; font-weight: 600; display: flex; align-items: center;">
                        <span style="color: var(--gold); font-size: 0.9rem; margin-right: 0.3rem;">→</span> Competence
                    </p>
                    <p style="color: var(--gray-light); font-size: 0.7rem; margin: 0; line-height: 1.2;">Operate within your area of expertise</p>
                </div>
                
                <div style="background: rgba(0, 0, 0, 0.15); padding: 0.5rem; border-radius: 4px; border-left: 2px solid var(--gold); box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
                    <p style="color: var(--gold-light); font-size: 0.8rem; margin: 0 0 0.1rem 0; font-weight: 600; display: flex; align-items: center;">
                        <span style="color: var(--gold); font-size: 0.9rem; margin-right: 0.3rem;">→</span> Safety Margin
                    </p>
                    <p style="color: var(--gray-light); font-size: 0.7rem; margin: 0; line-height: 1.2;">Build buffers for unexpected outcomes</p>
                </div>
            </div>
        </div>

        <div style="background: rgba(212, 175, 55, 0.06); padding: 0.6rem; border-radius: 5px; border: 1px solid rgba(212, 175, 55, 0.2);
                    margin: 0.6rem 0 0.5rem; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
            <h4 style="color: var(--gold); font-size: 0.85rem; margin: 0 0 0.4rem 0; display: flex; align-items: center; gap: 0.3rem;">
                <span style="font-size: 1rem;">📝</span> Final Decision
            </h4>
            <div style="border-bottom: 1px solid rgba(212, 175, 55, 0.25); height: 1.5rem;"></div>
            <p style="color: var(--gold-light); font-size: 0.7rem; margin: 0.3rem 0 0 0; text-align: center; font-style: italic; line-height: 1.2;">
                Sign and date to commit to this decision
            </p>
        </div>
...
function generateStrategicWarfareSection() {
    ...
    <div class="page" style="padding: 0.5rem 1rem;">
        <h1 class="text-center gold-gradient" style="font-size: 1.7rem; margin: 0.2rem 0 0.3rem 0;">Failure Recovery Protocols</h1>
        <div class="gold-line" style="margin-bottom: 0.3rem;"></div>
        
        <div style="background: rgba(212, 175, 55, 0.03); padding: 0.4rem; border-radius: 6px; border: 1px solid var(--gold); margin-bottom: 0.3rem;">
            <h3 style="color: var(--gold); font-size: 0.95rem; margin: 0 0 0.15rem 0;">🔥 When Everything Falls Apart</h3>
            <p style="color: var(--gray-light); font-size: 0.75rem; line-height: 1.2; margin: 0 0 0.15rem 0;">Napoleon lost at Waterloo. Edison failed 10,000 times. Jordan was cut from his high school team. Failure is not the opposite of success - it's the raw material of mastery. Here's how to weaponize your setbacks.</p>
            <p style="color: var(--gold-light); font-size: 0.75rem; line-height: 1.2; font-weight: 600; margin: 0;">Every master was once a disaster who refused to give up.</p>
        </div>
        
        <div style="font-size: 0.85rem; color: var(--gold); font-weight: 600; margin: 0.15rem 0;">⚠️ THE DAY 30 CRISIS</div>
        <div style="background: rgba(212, 175, 55, 0.02); padding: 0.25rem; border-radius: 4px; margin-bottom: 0.25rem;">
            <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.15rem 0;">When motivation dies and old habits resurface:</p>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin: 0.2rem 0;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin: 0.2rem 0;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin: 0.2rem 0;"></div>
        </div>
        
        <div style="font-size: 0.85rem; color: var(--gold); font-weight: 600; margin: 0.15rem 0;">📈 THE DAY 60 PLATEAU</div>
        <div style="background: rgba(212, 175, 55, 0.02); padding: 0.25rem; border-radius: 4px; margin-bottom: 0.25rem;">
            <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.15rem 0;">When progress stalls and doubt creeps in:</p>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin: 0.2rem 0;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin: 0.2rem 0;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin: 0.2rem 0;"></div>
        </div>
        
        <div style="font-size: 0.85rem; color: var(--gold); font-weight: 600; margin: 0.15rem 0;">😰 THE DAY 89 PANIC</div>
        <div style="background: rgba(212, 175, 55, 0.02); padding: 0.25rem; border-radius: 4px;">
            <p style="color: var(--gray-light); font-size: 0.75rem; margin: 0 0 0.15rem 0;">Fear of completion and what comes next:</p>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin: 0.2rem 0;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin: 0.2rem 0;"></div>
            <div style="border-bottom: 1px solid var(--gray-dark); height: 28px; margin: 0.2rem 0;"></div>
        </div>
